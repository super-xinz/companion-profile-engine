...
Write-Host "[1/5] liveness and readiness"
...
Write-Host "[2/5] capabilities and version contract"
...
Write-Host "[3/5] initialize and read"
...
Write-Host "[4/5] ingest one turn"
$turnId = "turn-$stamp"
...
Write-Host "[5/5] verify latest profile"
